/datum/job/roguetown/hand
	...
	tutorial = "Her şeyini hükümdarına borçlusun. Bir zamanlar sadece mütevazı bir dostken, şimdi krallığın en önemli adamlarından birisin. Yıllarca soylu aileye casusluk yaparak ve sırdaşlık ederek entrikalarla dolu bir hazineye dönüştün; bu bilgiyi de güçlü bir inançla kullanıyorsun. Kimse, kimin kulağına fısıldadığını asla unutmamalı. O dudaklarla, herhangi bir kılıç ustasının iddia edebileceğinden daha fazla adam öldürdün."
	whitelist_req = TRUE
