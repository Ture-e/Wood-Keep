/datum/job/roguetown/manorguard
	...
	tutorial = "Sadakatini ve yeteneğini kanıtladıktan sonra, Kraliyet Ailesi ve Sarayı savunma görevi sana verildi, \
				Düzenli olarak savaş ve kuşatma eğitimi alarak, Kral’ın saltanatında hayatta kalma şansını artırdın. \
				Majestelerinin maiyetinin bir parçası olarak ölmek bir onurdur, Mareşal size her gece bunu hatırlatır."
